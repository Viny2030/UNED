...
print("A: Carga de bibliotecas adicionales")
...
print("B-Descarga del libro y  limpieza, salida   en impresion y archivo json")
...
print("K-Frecuencia de entidades y grafico, en impresion  ")
...
print("M-Analisis de frecuencia, salida impresa y archivo json ")
...
print("N-Analisis de la frecuencia de las palabras del libro en salida impresa y archivo json ")
...
print("O-Analisis morfosintactico del libro en trasnformers, con salida impresa y archivo json ")
...
print("P-Analisis de entidades del libro en salida impresa y archivo json")
...
print("Q-Extraccion de entidades y analisis de sentimiento en archivo impreso y json")
...
print("S-Grafo de relaciones archivo impreso y json")
...
print("T-Salida de data frame de de centralidad y grafo, en archivo impreso y json.")
...
print("U-tokenizacion, etiquetas POS y lemmas en salida impresa")
...
print("V-Extraccion de lista de tuplas, sus etiquetas POS, lista de palabras, lemas, en salida archivo impreso json ")
...
print("W-Construccion de una matriz de confusion con las etiquetas del libro, con salida impresa y archivo json")
